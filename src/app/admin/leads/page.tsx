    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-2xl shadow-md max-w-sm w-full text-center">
          <h2 className="text-xl font-bold text-emerald-800 mb-4">Painel Nova Califórnia</h2>
          <form onSubmit={handleLogin}>
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm mb-3 outline-none focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 transition-all"
              required
            />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-700 hover:bg-emerald-800 disabled:bg-gray-400 text-white font-bold py-2.5 rounded-lg transition-colors text-sm cursor-pointer shadow-sm"
            >
