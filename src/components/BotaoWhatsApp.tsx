...
export default function BotaoWhatsApp({ 
  ...
  const handleWhatsAppClick = (e: React.MouseEvent) => {
    ...
    // Dispara o evento global para abrir o modal de cadastro de WhatsApp
  ...
  return (
    <button 
      ...
      className={`bg-[#25D366] hover:bg-[#1eb857] text-white font-bold py-3 px-6 rounded-full transition-all shadow-md hover:shadow-lg hover:scale-105 flex items-center justify-center gap-2 cursor-pointer text-sm uppercase tracking-wider focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 ${className}`}
      aria-label={texto}
    >
