...
export default function BotaoWhatsApp() {
  ...
  return (
    <button 
      ...
      className="bg-[#25D366] hover:bg-[#1eb857] text-white font-bold py-3 px-6 rounded-full transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer text-sm uppercase tracking-wider"
